# -*- coding: utf-8 -*-
"""
Created on Tue May 21 08:48:20 2024
...
#df.to_csv('data.xlsx', header=True,index =False) 
...
if __name__ == '__main__':    
   ...
   # print('上证指数分钟线\n',df)
    ...
    #df=get_price('300014',frequency='1d',count=120)      #默认获取今天往前120天的日线行情
    #df.to_csv('data.csv', header=True,index =False) 
    #print('上证指数日线行情\n',df.tail(5))
    
    #df = ak.stock_zh_a_spot_em()
    #df.to_csv('data.csv', header=True,index =False,encoding='utf-8-sig') 
    
    #stock_zh_a_daily_hfq_df = ak.stock_zh_a_daily(symbol="300014", adjust="hfq")
    #stock_zh_a_daily_hfq_df.to_csv('data.csv', header=True,index =False,encoding='utf-8-sig') 

    #print(stock_zh_a_daily_hfq_df)
    
    stock_zh_a_daily_qfq_df = ak.stock_zh_a_daily(symbol="sz300014", start_date="20231103", end_date="20241116", adjust="qfq")
    stock_zh_a_daily_qfq_df.to_csv('data.csv', header=True,index =False,encoding='utf-8-sig') 
